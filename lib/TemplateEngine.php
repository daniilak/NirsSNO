...
class TemplateEngine
{
    ...
    {
        if (!is_file(dirname(__DIR__) . '/tpl/page/' . $templateName) || !$this->templateBuffer = file_get_contents(dirname(__DIR__) . '/tpl/page/' . $templateName)) {
    ...
    {
        if (!$subBuffer = file_get_contents(dirname(__DIR__) . '/tpl/page/' . $subName)) {
