...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="../../dist/css/AdminLTE1.min.css?v=31">
  <link rel="stylesheet" href="../../dist/css/_all-skins1.min.css?v=31">
...
<body class="hold-transition layout-top-nav skin-green fixed sidebar-collapse  pace-done">
  <div class="wrapper">
